...
def game():
    ...
    if play == "yes":
        def scene_1():
            ...
            x()
            print("Acheivement Earned: Home Depot Run")
            x()
            print("     \@@@@|     |####/ ")
            print("      \@@@|     |###/ ")
            print("       `@@|_____|##' ")
            ...
            x()
            input_5 = input("Do you accept it? Type 'yes' or 'no', but beware!").lower()
            if input_5 == 'yes':
                x()
                ...
                input_6 = input("Would you care to skip the next level?").lower()
                if input_6 == 'yes':
                ...
                x()
                print("Eventually you are able to clear a path. And that's when you see it. The bridge.")
                x()
                print("You stumble up to the bridge, confused as to how it came to be in a laundromat.")
                x()
                print("""The Bridgekeeper stares at you and says, "STOP! Who would cross the Bridge of Death must answer me these questions three, ere the other side he see.""")
                x()
                print("""You reply: "Ask me your questions, Bridgekeeper. I'm not afraid!""")
                x()
                print("The bridgekeeper cackles.")
                input_7 = input("What... is your name?")
                x()
                input_8 = input("What... is your quest?")
                x()
                print("What... is the airspeed velocity of an unladen swallow?")
                x()
                print("You blink. You have no idea, but the bridgekeeper doesn't know that.")
                x()
                print("""Summoning your best movie lore from the 1970s, you tentatively inquire, "What do you mean, an African or European swallow?""")
                x()
                print("""The bridgekeeper looks confused. "Huh? What? I... I don't know that...""")
                print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAUUUGGHHHHHHH!")
                x()
                print("The bridgekeeper is thrown overboard into the Gorge of Eternal Peril.")
                x()
                print("You hurry over the bridge. Encircled in a heavenly glow of light is the entrance to the laundromat. You rush to the door.")
                x()
